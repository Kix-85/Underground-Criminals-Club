...
namespace UCC
{
    public partial class MathsChallenge : Form
    {
        ...
        public MathsChallenge()
        {
            InitializeComponent();
            BackgroundImage = Image.FromFile(imagePath + "mainBG.png");
            Next.Enabled = false;
            Back.Enabled= false;
            mathsQuestions = File.ReadAllLines(filePath + "MathChallengeData.txt");
            QandA = mathsQuestions[questionNumber].Split(",");
            QandA[1].Trim();
